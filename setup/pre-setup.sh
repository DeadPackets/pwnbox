...
apt-fast install --no-install-recommends -y locales man-db git wget curl python2.7 python3 python3-dev python3-pip python3-venv python3-setuptools netcat ruby sudo jq nmap && \
